...
TArray<TPair<FName,__int64>,TSizedDefaultAllocator<32> >& UEnum::GetNames()
{
    ...
    return *Helper::Casting::ptr_cast<TArray<TPair<FName,__int64>,TSizedDefaultAllocator<32> >*>(this, offset->second);
}
const TArray<TPair<FName,__int64>,TSizedDefaultAllocator<32> >& UEnum::GetNames() const
{
    static auto offset = MemberOffsets.find(STR("Names"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UEnum::Names' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<const TArray<TPair<FName,__int64>,TSizedDefaultAllocator<32> >*>(this, offset->second);
}
