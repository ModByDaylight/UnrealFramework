#ifndef RC_UNREAL_XUINT64PROPERTY_HPP
#define RC_UNREAL_XUINT64PROPERTY_HPP
...
namespace RC::Unreal
{
    class RC_UE_API XUInt64Property : public XNumericProperty
    {
    private:

    public:
        constexpr static inline bool is_trivial = true;
        constexpr static inline int32_t size = sizeof(uint64_t);
        ...
        {
            if (!m_static_obj_variant.is_valid()) { throw std::runtime_error{"[XUInt64Property::static_class] m_static_obj_variant is not valid"}; }
...
#endif //RC_UNREAL_XUINT64PROPERTY_HPP
