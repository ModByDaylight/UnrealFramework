...
namespace RC::Unreal
{
    std::unordered_map<EObjectFlags, Flags425::EObjectFlags_Impl> Flags425::object_flags_converter{
            ...
            {EObjectFlags::RF_WillBeLoaded, EObjectFlags_Impl::RF_WillBeLoaded},
            {EObjectFlags::RF_HasExternalPackage, EObjectFlags_Impl::RF_HasExternalPackage},
    };

    auto Flags425::to_impl_flags(const std::array<EObjectFlags, EObjectFlags_Max>& flags) -> EObjectFlags_Impl
    {
