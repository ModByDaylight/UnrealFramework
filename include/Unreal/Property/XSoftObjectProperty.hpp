#ifndef RC_UNREAL_XSOFTOBJECTPROPERTY_HPP
#define RC_UNREAL_XSOFTOBJECTPROPERTY_HPP

#include <Unreal/Property/XObjectProperty.hpp>

namespace RC::Unreal
{
    class RC_UE_API XSoftObjectProperty : public XObjectProperty
    {
    private:
    ...
    public:
        ...
        {
            if (!m_static_obj_variant.is_valid()) { throw std::runtime_error{"[XSoftObjectProperty::static_class] m_static_obj_variant is not valid"}; }
...
#endif //RC_UNREAL_XSOFTOBJECTPROPERTY_HPP
