#ifndef UNREAL_PLATFORMFILE_HPP
#define UNREAL_PLATFORMFILE_HPP
 ...
 */
struct RC_UE_API FFileStatData {
    FORCEINLINE FFileStatData()
    ...
    FORCEINLINE FFileStatData(FDateTime InCreationTime, FDateTime InAccessTime,	FDateTime InModificationTime, const int64 InFileSize, const bool InIsDirectory, const bool InIsReadOnly)
...
* File I/O Interface
**/
class RC_UE_API IPlatformFile {
public:
    /** Returns the name of the physical platform file type. */
    FORCEINLINE static const TCHAR* GetPhysicalTypeName() {
    ...
    */
    virtual IAsyncReadFileHandle* OpenAsyncRead(const TCHAR* Filename) = 0;
    ...
    */
    ...
    virtual FDateTime GetTimeStampLocal(const TCHAR* Filename) = 0;
    ...
    **/
     ...
     * @return				false if the directory did not exist or if the visitor returned false.
    **/
    virtual bool IterateDirectoryRecursively(const TCHAR* Directory, FDirectoryVisitor& Visitor) = 0;
     ...
     * @return				false if the directory did not exist or if the visitor returned false.
    **/
    virtual bool IterateDirectoryStatRecursively(const TCHAR* Directory, FDirectoryStatVisitor& Visitor) = 0;
    ...
    **/
     ...
     * @return FoundFiles		All the files that matched the optional FileExtension filter, or all files if none was specified.
     */
    virtual void FindFilesRecursively(TArray<FString>& FoundFiles, const TCHAR* Directory, const TCHAR* FileExtension) = 0;
    ...
    **/
    virtual bool DeleteDirectoryRecursively(const TCHAR* Directory) = 0;
    ...
    **/
    virtual bool CopyFile(const TCHAR* To, const TCHAR* From, EPlatformFileRead ReadFlags = EPlatformFileRead::None, EPlatformFileWrite WriteFlags = EPlatformFileWrite::None) = 0;
     ...
     * @return								true if operation completed successfully.
     */
    virtual bool CopyDirectoryTree(const TCHAR* DestinationDirectory, const TCHAR* Source, bool bOverwriteAllExisting) = 0;
