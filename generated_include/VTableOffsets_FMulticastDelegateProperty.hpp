struct VTableOffsets
{
    ...
    static uint32_t FMulticastDelegateProperty_Destructor;
    static uint32_t GetCPPTypeForwardDeclaration;
    static uint32_t ConvertFromType;
    static uint32_t SetMulticastDelegate;
