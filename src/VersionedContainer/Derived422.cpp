...
namespace RC::Unreal
{
    auto Derived422::Field_get_type_fname(const FField* p_this) -> FName
    {
    ...
    auto Derived422::Field_get_ffield_owner([[maybe_unused]]const FField* p_this) -> void*
    {
    ...
    auto Derived422::FFieldClass_get_fname(const FFieldClass* p_this) -> FName
    {
    ...
    auto Derived422::find_property_vc(void* uobject, const wchar_t* property_string, Base::WithSideEffects with_side_effects, ExcludeSelf exclude_self) -> PropertyDataVC
    {
    ...
    auto Derived422::read_property_vc(void* uobject, const wchar_t* property_string, CustomProperty* custom_property) -> PropertyDataVC
    {
        FProperty* property{};
