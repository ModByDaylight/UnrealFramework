...
namespace RC::Unreal
{
    std::unordered_map<EObjectFlags, Flags422::EObjectFlags_Impl> Flags422::object_flags_converter{
    ...
    auto Flags422::to_impl_flags(const std::array<EObjectFlags, EObjectFlags_Max>& flags) -> EObjectFlags_Impl
    {
