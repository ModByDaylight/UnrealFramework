#ifndef RC_UNREAL_XLAZYOBJECTPROPERTY_HPP
#define RC_UNREAL_XLAZYOBJECTPROPERTY_HPP
...
namespace RC::Unreal
{
    ...
    public:
        ...
        {
            if (!m_static_obj_variant.is_valid()) { throw std::runtime_error{"[XLazyObjectProperty::static_class] m_static_obj_variant is not valid"}; }
...
#endif //RC_UNREAL_XLAZYOBJECTPROPERTY_HPP
