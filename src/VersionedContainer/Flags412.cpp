...
namespace RC::Unreal
{
    std::unordered_map<EObjectFlags, Flags412::EObjectFlags_Impl> Flags412::object_flags_converter{
            ...
            {EObjectFlags::RF_NeedInitialization, static_cast<EObjectFlags_Impl>(-1)},
            {EObjectFlags::RF_NeedLoad, EObjectFlags_Impl::RF_NeedLoad},
            {EObjectFlags::RF_KeepForCooker, static_cast<EObjectFlags_Impl>(-1)},
            ...
            {EObjectFlags::RF_NewerVersionExists, static_cast<EObjectFlags_Impl>(-1)},
            ...
            {EObjectFlags::RF_DuplicateTransient, static_cast<EObjectFlags_Impl>(-1)},
            {EObjectFlags::RF_StrongRefOnFrame, EObjectFlags_Impl::RF_StrongRefOnFrame},
            {EObjectFlags::RF_NonPIEDuplicateTransient, static_cast<EObjectFlags_Impl>(-1)},
    ...
    auto Flags412::to_impl_flags(const std::array<EObjectFlags, EObjectFlags_Max>& flags) -> EObjectFlags_Impl
    {
