#ifndef RC_UNREAL_XINT8PROPERTY_HPP
#define RC_UNREAL_XINT8PROPERTY_HPP
...
namespace RC::Unreal
{
    ...
    public:
        ...
        constexpr static inline int32_t size = sizeof(int8_t);
        ...
        {
            if (!m_static_obj_variant.is_valid()) { throw std::runtime_error{"[XInt8Property::static_class] m_static_obj_variant is not valid"}; }
...
#endif //RC_UNREAL_XINT8PROPERTY_HPP
