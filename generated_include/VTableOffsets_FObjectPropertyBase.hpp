struct VTableOffsets
{
    ...
    static uint32_t CheckValidObject;
    ...
    static uint32_t SetObjectPropertyValue;
    ...
    static uint32_t GetCPPTypeCustom;
    static uint32_t GetObjectPropertyValue;
    static uint32_t AllowCrossLevel;
    static uint32_t UObjectPropertyBase_Destructor;
    static uint32_t __vecDelDtor;
    static uint32_t SupportsNetSharedSerialization;
    static uint32_t LoadObjectPropertyValue;
    static uint32_t AddReferencedObjects;
    static uint32_t PostDuplicate;
    static uint32_t FObjectPropertyBase_Destructor;
};
