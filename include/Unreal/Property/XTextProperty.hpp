#ifndef RC_UNREAL_XTEXTPROPERTY_HPP
#define RC_UNREAL_XTEXTPROPERTY_HPP
...
namespace RC::Unreal
{
    ...
    public:
        ...
        constexpr static inline int32_t size = sizeof(FText);
        using InnerType = FText;
        ...
        {
            if (!m_static_obj_variant.is_valid()) { throw std::runtime_error{"[XTextProperty::static_class] m_static_obj_variant is not valid"}; }
...
#endif //RC_UNREAL_XTEXTPROPERTY_HPP
